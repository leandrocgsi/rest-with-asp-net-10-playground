...
namespace RestWithASPNET10Erudio.Tests.IntegrationTests.HATEOAS
{
        ...
        : IClassFixture<SqlServerFixture>
    {
        ...
        [Fact(DisplayName = "05 - Find All Persons (Paged + HATEOAS)")] // ALTERADO
        [TestPriority(5)]
        public async Task FindAll_ShouldReturnLinksForEachPerson()
        {
            ...
            // Assert
            // Regex precisa procurar IDs dentro de "list" // ALTERADO
            ...
            foreach (Match match in idMatches)
            {
                ...
                // Expected hypermedia relations (agora inclui também "patch") // ALTERADO
                ...
                foreach (var rel in expectedRels)
                {
                    ...
                    {
                        "self" or "delete" or "patch" => // ALTERADO
